...
<head>
    ...
    <link rel="stylesheet" href="../../Public/assets/styles/PagFaculdade/MeuCurso/faculdade.meuCurso.css">
...
<body>
    ...
    <div id="myModal" class="modal">
        ...
        <div class="quadro">
            ...
            <div id="btn-pop">
                <button class="close excluir">Cancelar</button> <button class="btn-default"> <a
                        href="">Excluir</a></button>
            </div>
        </div>
    </div>
<div id="quadro">
...
<script src="../../Public/assets/Js/faculdade.index.js"></script>
