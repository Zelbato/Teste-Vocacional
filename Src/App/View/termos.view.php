...
<head>
    ...
    <link rel="stylesheet" href="../../Public/assets/styles/termos/termos.css">
...
<div vw class="enabled">
    ...
    <main class="main ">
            ...
            <main class="main">
                <setion class="termos">
                    <div class="termos-titulo">
                        <h1>Termos de uso do website</h1>
                    </div>
                    ...
                    <aside class="termos-uso">
                        ...
                        <div class="termos-paragrafo">
                            ...
                            <p>Ao acessar ao site Teste vocacional, concorda em cumprir estes termos de serviço,
                                ...
                                termos, está proibido de usar ou acessar este site. Os materiais contidos neste site
                            ...
                            <p>É concedida permissão para baixar temporariamente uma cópia dos materiais
                                (informações ou software) no site Teste vocacional , apenas para visualização
                            ...
                            <ul>
                                <li class="uso">1: Modificar ou copiar os materiais; </li>
                                <li>2: Usar os materiais para qualquer finalidade comercial ou para exibição pública
                                    (comercial
                                    ou não comercial); </li>
                                <li>3: Tentar descompilar ou fazer engenharia reversa de qualquer software contido no site
                                    Teste
                                    vocacional; </li>
                                <li>4: Remover quaisquer direitos autorais ou outras notações de propriedade dos materiais;
                                </li>
                                <li>5: Transferir os materiais para outra pessoa ou 'espelhe' os materiais em qualquer outro
                                    servidor.</li>
                            </ul>
                            <br>

                            <p>Esta licença será automaticamente rescindida se você violar alguma dessas restrições e
                                poderá ser rescindida por Teste vocacional a qualquer momento. Ao encerrar a visualização
                            ...
                            <p>1:Os materiais no site da Teste vocacional são fornecidos 'como estão'.
                                Teste vocacional não oferece garantias, expressas ou implícitas, e, por este meio,
                                ...
                                de direitos.</p>
                            <p>2:Além disso, o Teste vocacional não garante ou faz qualquer representação relativa à
                                precisão, aos resultados prováveis ​​ou à confiabilidade do uso dos materiais em seu site ou
                                de
                                outra forma relacionado a esses materiais ou em sites vinculados a este site.</p>
                            <br>
                            <h3>4.Limitações</h3>

                            <p>Em nenhum caso o Teste vocacional ou seus fornecedores serão responsáveis ​​por quaisquer
                                dano
                                s (incluindo, sem limitação, danos por perda de dados ou lucro ou devido a interrupção dos
                                negócios) decorrentes do uso ou da incapacidade de usar os materiais em Teste vocacional,
                                mesmo que Teste vocacional ou um representante autorizado da Teste vocacional tenha sido
                            ...
                            <p>5. Precisão dos materiais
                                Os materiais exibidos no site da Teste vocacional podem incluir erros técnicos,
                                tipográficos ou fotográficos. Teste vocacional não garante que qualquer material
                                em seu site seja preciso, completo ou atual. Teste vocacional pode fazer alterações
                                nos materiais contidos em seu site a qualquer momento, sem aviso prévio. No entanto,
                                Teste vocacional não se compromete a atualizar os materiais.</p>
                            <br>
                            <h3>6.Links</h3>

                            <p>O Teste vocacional não analisou todos os sites vinculados ao seu site e
                                não é responsável pelo conteúdo de nenhum site vinculado. A inclusão de qualquer
                                link não implica endosso por Teste vocacional do site. O uso de qualquer site
                                vinculado é por conta e risco do usuário.</p>
                            <br>

                            <h3>Modificações</h2>

                                <p>O Teste vocacional pode revisar estes termos de serviço do site
                                ...
                                <h3>Lei aplicável</h2>
                                    ...
                                    <p>Estes termos e condições são regidos e interpretados de acordo com as leis do Teste
                                        vocacional e você se submete irrevogavelmente à jurisdição exclusiva dos tribunais
                                        naquele estado ou localidade.</p>
       ...
       <p>Desenvolvido por <a href="https://github.com/Zelbato/"> Franzin </a> -->
            ...
            <script src="../../Public/assets/Js/termos.js"></script>
