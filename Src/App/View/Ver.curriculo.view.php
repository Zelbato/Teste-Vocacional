...
// $query = "SELECT * FROM curriculos WHERE user_id = ?";
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../../Public/assets/styles/curriculo/Ver.css">
        ...
        <section class="form-curriculo">
            ...
            <ul class="ul">
                <?php while ($curriculo = $result->fetch_assoc()): ?>
                    <li class="li">
                        <strong><?php echo htmlspecialchars($curriculo['nome']); ?></strong><br>
                        <a href="baixar_curriculo.php?id=<?php echo $curriculo['id']; ?>">Baixar</a> |
                        <a href="editar_curriculo.php?id=<?php echo $curriculo['id']; ?>">Editar</a>
                    </li>
                <?php endwhile; ?>
            </ul>
        </section>
