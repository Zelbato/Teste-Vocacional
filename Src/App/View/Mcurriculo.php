...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../../Public/assets/styles/curriculo/meuCurriculo.css">
            ...
            <ul>
                <?php while ($curriculo = $resul->fetch_assoc()): ?>
                    <li>
                        ...
                        <a href="editarcurriculoTela.php?id=<?php echo $curriculo['id']; ?>">Editar</a>
