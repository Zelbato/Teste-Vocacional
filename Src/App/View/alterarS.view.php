...
<head>
    ...
    <link rel="stylesheet" href="../../Public/assets/styles/Alterar_Senha/Alterar_Senha.css">
...
<body>
            ...
            <section class="form">
                <form action="#">
                    ...
                    <aside class="continue-button">
                        <button><a href="index.view.php">Enviar</a></button>
                    </aside>
                </form>
            </section>
        </article>
    ...
    <script src="../../Public/assets/Js/Alterar_Senha.js"></script>
