...
<head>
    ...
    <link rel="stylesheet" href="../../Public/assets/styles/recuperacao/recuperar.css">
...
<body>
    ...
    <aside class="voltar">
        <div class="voltar-content">
            <button class="voltar-btn"> <a href="login.html"><i class="bi bi-arrow-left"></i></a></button>
        </div>
    </aside>
            ...
            <section class="form">
                <form action="#">
                    ...
                    <aside class="continue-button">
                        <button><a href="codigoV.view.php">Enviar</a></button>
                    </aside>
                </form>
            </section>
        </article>
